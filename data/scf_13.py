...
# Keep list:
#Keep = [WGT, WGT0, CHECKING, SAVING, MMA, CALL, LIQ, CDS]
...
scf.FARMBUS=(scf.X507/10000)*(scf.X513+scf.X526-scf.X805-scf.X905-scf.X1005)\
    ...
    -((scf.X1136>0) & ((scf.X1108+scf.X1119+scf.X1130)>0))*(scf.X1136*(scf.X507/10000)*(scf.X1108*(scf.X1103==1)\
...
scf.X1136=scf.X1136-((scf.X1136>0) & ((scf.X1108+scf.X1119+scf.X1130)>0))*scf.X1136*(scf.X507/10000)*((scf.X1108*(scf.X1103==1)\
    +scf.X1119*(scf.X1114==1)+scf.X1130*(scf.X1125==1))/(scf.X1108+scf.X1119+scf.X1130))
...
scf.MRTHEL=scf.X805+scf.X905+scf.X1005+\
        ((scf.X1108+scf.X1119+scf.X1130)>=1)*(scf.X1108*(scf.X1103==1)+scf.X1119*(scf.X1114==1)+scf.X1130*(scf.X1125==1)\
...
scf.OTHLOC=((scf.X1108+scf.X1119+scf.X1130)>=1)*(scf.X1108*(scf.X1103!=1)+scf.X1119*(scf.X1114!=1)+scf.X1130*(scf.X1125!=1)+\
        scf.X1136*(scf.X1136>=0)*(scf.X1108*(scf.X1103!=1)+scf.X1119*(scf.X1114!=1)+\
        scf.X1130*(scf.X1125!=1)).divide(scf.X1108+scf.X1119+scf.X1130))+\
...
scf.VEH_INST=scf.X2218+scf.X2318+scf.X2418+scf.X7169+scf.X2424+scf.X2519+scf.X2619+scf.X2625
scf.EDN_INST=scf.X7824+scf.X7847+scf.X7870+scf.X7924+scf.X7947+scf.X7970+scf.X7179+\
        scf.X2723*(scf.X2710==83)+scf.X2740*(scf.X2727==83)+scf.X2823*(scf.X2810==83)+\
        scf.X2840*(scf.X2827==83)+scf.X2923*(scf.X2910==83)+scf.X2940*(scf.X2927==83)
...
scf.OUTPEN=scf.OUTPEN1+scf.OUTPEN2+scf.OUTPEN3+scf.OUTPEN4+scf.OUTPEN5+scf.OUTPEN6
